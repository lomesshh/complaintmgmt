...
<br>
    ...
    <div class="main-content" style="opacity: 0.7; margin-top: 5rem;">
                    ...
                    <div class="form-row">
                        <label>
                            ...
                            <input type="password" name="txt_password" id="password" placeholder="">
                                   ...
                                   <input type="submit" style="background-color: #FF6347; color: white; border-radius: 10px;" name="btn_login" value="Login"><br><br>
                                   <input type="submit" style="background-color: #FF6347; color: white; border-radius: 10px;" formaction="getotp.jsp" value="Login Using OTP"><br><br><br>
